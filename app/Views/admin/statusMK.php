            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('/admin/MK'); ?>">Pesanan Menunggu Konfirmasi</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Pesanan Menunggu Konfirmasi</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($order as $data) : ?>
                                                <tr>
                                                    ...
                                                    <?php endif; ?>
                                                    <td align="center">
                                                        <button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#modal1<?= $data['id_order']; ?>">
...
<!-- Modal Bukti -->
<?php foreach ($order as $data) : ?>
    <div class="modal fade" id="modal1<?= $data['id_order']; ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="modal1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modal1<?= $data['id_order']; ?>"><b>Bukti Pembayaran</b></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p align="center">
                        <img src="/image/upload/buktiPembayaran/<?= $data['file_bukti']; ?>" style="display: block; margin-left: auto; margin-right: auto; width: 210px; height: 310px;">
                    </p>
                    <hr>
                    <p align="center">
                        <a href="<?= site_url('download/' . $data['id_order']); ?>" type="button" class="btn btn-info mb-3">
                            <span class="btn-label">
                    ...
                    <p align="center">
                        <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#cancel<?= $data['id_order']; ?>">
                            <span class="btn-label">
                                <i class="fa-solid fa-xmark"></i>
                            </span>
                            Batalkan Pesanan
                        </button>
                        <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modal2<?= $data['id_order']; ?>">
                            <span class="btn-label">
    ...
    <div class="modal fade" id="cancel<?= $data['id_order']; ?>" tabindex="-1" aria-labelledby="cancel<?= $data['id_order']; ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal1<?= $data['id_order']; ?>" data-bs-dismiss="modal">Batal</button>
    ...
    <div class="modal fade" id="modal2<?= $data['id_order']; ?>" tabindex="-1" aria-labelledby="modal2<?= $data['id_order']; ?>" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 style="color: black;">Apa anda yakin ingin mengkonfirmasi pesanan ?</h6>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#modal1<?= $data['id_order']; ?>" data-bs-dismiss="modal">Batal</button>
