            ...
            <div class="page-inner">
                <div class="page-header">
                    ...
                    <ul class="breadcrumbs mb-3">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('/admin/Arrived'); ?>">Pesanan Arrived</a>
                        </li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Pesanan Arrived</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach ($order as $data) : ?>
                                                <tr>
                                                    ...
                                                    <?php endif; ?>
                                                    <td align="center">
                                                        <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modal1<?= $data['id_order']; ?>">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h6 style="color: black;">Apa anda yakin ingin menghapus pesanan ?</h6>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger btn-sm" data-bs-dismiss="modal">Batal</button>
                    <a href="<?= base_url('/admin/status/hapus/' . $data['id_order']); ?>" style="text-decoration: none;">
